...
\begin{center}
    ...
    \begin{tabularx}{\textwidth}{l l >{\raggedleft}X l}
        分类号：           & \uline{\hfill 按中国图书分类法，学位办网上可查\hfill}  & % 记得填写！
        % 中图分类代号查询网站：http://ztflh.xhma.com/
        单位代码：         & \uline{\hfill 10335 \hfill} \\% 不要修改
        密{\quad}级：      & \uline{\hfill 注明密级与保密期限\hfill} &
        % 记得填写（公开 or 秘密★10年 or 绝密★10年 or 机密★10年）
        学{\quad\quad}号： & \uline{\hfill \StudentID \hfill}% 不要在此修改
    \end{tabularx}
\end{center}
...
\begin{center}
    \includegraphics[width=0.1\paperwidth]{logo/zju.pdf}
\end{center}
