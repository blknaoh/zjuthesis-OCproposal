...
% 中英文标题、密级、分类号请移步./page/graduate/cover-chn.tex中修改，此处填写无效
% ================================
...
\documentclass[
    ...
    Grade           = 2019,           % 此项可不用管，不会在文中出现
    Major           = 专业,           % 例：船舶与海洋工程 or 海洋信息科学与技术 or 海洋技术与工程
    Department      = 海洋学院,       % 例：海洋学院
    Title           = 此处填写无效,   % 请移步./page/graduate/cover-chn.tex中修改，此处填写无效
    ...
    GradLevel       = master,         % 硕士填master，博士填doctor
    Topic           = 研究方向,       % 例：水声通信
    ColaboratorName = 合作导师,       % 例：王五  
    TitleEng        = {{此处填写无效}}% 请移步./page/graduate/cover-chn.tex中修改，此处填写无效
]{zjuthesis}
